...
def run_instance(
    ...
    residuals = energies - optimal_energy
...
def main(args: argparse.Namespace) -> None:
    ...
    results_dir = os.path.join(current_dir, "results_vca")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="TSP-200 VCA experiment with extended logging.")
